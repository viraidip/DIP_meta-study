...
from overall_comparision.general_analyses import plot_distribution_over_segments, calculate_deletion_shifts, length_distribution_heatmap, length_distribution_violinplot, plot_nucleotide_ratio_around_deletion_junction_heatmaps, plot_direct_repeat_ratio_heatmaps, start_vs_end_lengths, diff_start_end_lengths
...
def patient_intersection(dfs, dfnames):
    ...
    for df, dfname in zip(dfs, dfnames):
        ...
        # Display the result
        print(count_occurrences.sort_values(by='count', ascending=True))
...
if __name__ == "__main__":
    ...
    patient_dfnames = ["WRA2021_B", "Lauring2019"]#, "Southgate2019"]
    patient_dfs = list()
